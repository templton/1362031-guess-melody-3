    ...
    <section className="game game--artist">
      ...
      <section className="game__screen">
        ...
        <form className="game__artist">
          ...
          <div className="artist">
            <input className="artist__input visually-hidden" type="radio" name="answer" value="artist-2"
                   id="answer-2"/>
          ...
          <div className="artist">
            <input className="artist__input visually-hidden" type="radio" name="answer" value="artist-3"
                   id="answer-3"/>
